...
def main(n, M, D, C, y, ratio_data, P_max, Epochs, alpha, Random_seed):
...
main(n, M, D, C, y, r, P_max, Epochs, alpha, Random_seed)
"""
if __name__ == "__main__":
    ...
    if (args.D == 1 and (args.n > 100 )) or (args.D == 2 and (args.n > 30)) or (args.D == 3 and (args.n > 10)):
        ...
        main(args.n, args.M, args.D, C, y, args.r, args.P_max, args.Epochs, args.alpha, args.Random_seed)
"""
